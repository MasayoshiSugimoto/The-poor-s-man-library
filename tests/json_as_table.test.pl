...
pm_test_util::assert_equals(0, $table->row_get(0)->get("a"), "table[0]{a}");
pm_test_util::assert_equals(1, $table->row_get(0)->get("b"), "table[0]{b}");
pm_test_util::assert_equals(2, $table->row_get(1)->get("a"), "table[1]{a}");
pm_test_util::assert_equals(3, $table->row_get(1)->get("b"), "table[1]{b}");
pm_test_util::assert_equals(4, $table->row_get(2)->get("a"), "table[2]{a}");
pm_test_util::assert_equals(5, $table->row_get(2)->get("b"), "table[2]{b}");
